...
*   **The Solution:** You need a **Chiral Engine**—a central logic core that understands the shared DNA but synthesizes the distinct "left-handed" (AWS), "right-handed" (Azure), and "right-handed" (GCP) artifacts.
