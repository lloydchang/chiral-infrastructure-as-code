...
// This demonstrates using lightweight AWS simulators for partial local development

import { ChiralSystem } from '../../src/intent';

export const config: ChiralSystem = {
  projectName: 'myproject-aws-simulator',
  environment: 'dev',
  ...
  region: {
    local: 'localhost',
    aws: 'us-east-1', // Simulator will simulate this region
  },
