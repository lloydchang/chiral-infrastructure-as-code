...
// This demonstrates using lightweight GCP simulators for partial local development

import { ChiralSystem } from '../../src/intent';

export const config: ChiralSystem = {
  projectName: 'myproject-gcp-simulator',
  environment: 'dev',
  ...
  region: {
    local: 'localhost',
    gcp: 'us-central1', // Simulator will simulate this region
  },
